...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    ModificarDatos(int id) {
        initComponents();
        this.id=id;
        coche = control.traerCoche(id);
        ...
        txtPuertas.setText(String.valueOf(coche.getCantPuertas()));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        control.modificar(id, modelo, marca, color, motor, matricula, puertas);
